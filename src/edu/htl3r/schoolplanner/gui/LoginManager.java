...
public class LoginManager {
	...
	/**
	 * Füge ein LoginEntry zu den SharedPreferences
	 * 
	 * @param le
	 * @return
	 */
	public boolean addLoginEntry(LoginEntry le) {
	...
	public boolean addLoginEntry(String name, String url, String school, String user) {
		return addLoginEntry(new LoginEntry(getDataEntry(name, url, school, user)));
	}

	/**
	 * Auslesen aller gespeicherten Entries
	 * 
	 * @return
	 */
	public List<Map<String, String>> getAllLoginEntries() {
	...
	/**
	 * Lösche ein LoginEntry
	 * 
	 * @param le
	 * @return
	 */
	public boolean deleteLoginEntry(LoginEntry le) {
