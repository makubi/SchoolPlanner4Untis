...
public class WeekView extends ViewGroup {
	...
	private void init() {
		...
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 255, 0, 0), "rot"));
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 0, 255, 0), "gruen"));
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 0, 0, 255), "blau"));
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 0, 0, 255), "hans"));
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 255, 0, 0), "rot"));
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 0, 255, 0), "gruen"));
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 0, 0, 255), "blau"));
		addView(new LessonView(getContext(), new Lesson(), Color.argb(100, 0, 0, 255), "hans"));
